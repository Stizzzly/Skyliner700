...
src/win32/        Точка входа Win32, ввод/окно, камеры, D3D9-рендерер
...
assets/           Runtime-ассеты Windows и Xbox 360
tests/            Headless CTest-проверки модели полёта
```

Решение Xbox 360 открывается по пути `platforms/xbox360/Skyliner700Xbox360/Skyliner700xbox360.sln`. Заголовки, библиотеки и примеры XDK намеренно не включены в репозиторий.
